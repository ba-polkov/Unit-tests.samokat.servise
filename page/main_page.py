...
class MainPage(BasePage):
    ...
    def wait_visability_of_order_button_in_header(self):
        self.wait_visability_of_elements(MainPageLocators.order_button_in_header)
    ...
    def wait_visability_of_header_logo_scooter(self):
        self.wait_visability_of_elements(MainPageLocators.header_logo_scooter)
    
    @allure.step ('Ожидание загрузки "Яндекс" (лого) в хедере')
    def wait_visability_of_header_logo_yandex(self):
        self.wait_visability_of_elements(MainPageLocators.header_logo_yandex)
    ...
    def wait_visability_of_main_header(self):
        self.wait_visability_of_elements(MainPageLocators.main_header)
    ...
    def wait_visability_of_faq_items(self,data):
        self.wait_visability_of_elements(MainPageLocators.faq_question_items[data])
    ...
    def wait_visability_of_faq_answer(self, data):
        self.wait_visability_of_elements(MainPageLocators.faq_answers_items[data])
